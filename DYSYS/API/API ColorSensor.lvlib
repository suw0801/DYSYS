...
<Library LVVersion="11008008">
	...
	<Item Name="API Color Sensor Dev Init.vi" Type="VI" URL="../API Color Sensor Dev Init.vi"/>
	<Item Name="API Color Sensor Dev Release.vi" Type="VI" URL="../API Color Sensor Dev Release.vi"/>
	<Item Name="API Color Sensor Get Color.vi" Type="VI" URL="../API Color Sensor Get Color.vi"/>
</Library>
