...
<Library LVVersion="11008008">
	...
	<Item Name="API BARINIT.vi" Type="VI" URL="../API BARINIT.vi"/>
	<Item Name="API BAROpen.vi" Type="VI" URL="../API BAROpen.vi"/>
	<Item Name="API BARQUIT.vi" Type="VI" URL="../API BARQUIT.vi"/>
	<Item Name="API BARRead.vi" Type="VI" URL="../API BARRead.vi"/>
</Library>
